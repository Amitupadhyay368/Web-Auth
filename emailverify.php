...
<body>
  ...
  <div class="middle" >
    <h1 style="color: black;font-size:4vh;" class="glow">A verification mail has been send to your e-mail.</h1>
    
    <p style="font-size: 3vh;"><?php  echo $email;  ?>
    <span style="font-size: 2vh;">To verify now <a href="https://mail.google.com/mail/" style="text-decoration:none;color: black;font-size: 2.5vh;">click here  <i class="fas fa-envelope" style="color: #33cc33"></i></a></span></p>
